...
all_solutions={
	...
	"BEING ON THEIR PHONE WHILE DRIVING|INCREASES WISDOM,INCRESES MULTITASKING,INCREASES INTELLIGENCE",
	...
	"LOSING THEIR KEYS|INSTILLS PARANOIA,INCREASES WISDOM,INCREASES MEMORY,REDUCES MEMORY LOSS",
